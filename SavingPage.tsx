...
<Text style={styles.sectionTitle}>Dịch vụ tiết kiệm</Text>
<View style={styles.grid}>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="calendar" size={24} color="black" />
    <Text style={styles.circleText}>Gửi tiết kiệm có kỳ hạn</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="cash" size={24} color="black" />
    <Text style={styles.circleText}>Gửi tiết kiệm tích lũy</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="arrow-down-circle" size={24} color="black" />
    <Text style={styles.circleText}>Rút tiền tiết kiệm</Text>
  </TouchableOpacity>
</View>

{/* Tiêu đề Dịch vụ đầu tư */}
<Text style={styles.sectionTitle}>Dịch vụ đầu tư</Text>
<View style={styles.grid}>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="bar-chart" size={24} color="black" />
    <Text style={styles.circleText}>Chứng khoán</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="business" size={24} color="black" />
    <Text style={styles.circleText}>Bất động sản</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="file-tray-full" size={24} color="black" />
    <Text style={styles.circleText}>Trái phiếu</Text>
  </TouchableOpacity>
  <TouchableOpacity style={styles.circleButton}>
    <Ionicons name="ribbon" size={24} color="black" />
    <Text style={styles.circleText}>Chứng chỉ quỹ</Text>
  </TouchableOpacity>
</View>
